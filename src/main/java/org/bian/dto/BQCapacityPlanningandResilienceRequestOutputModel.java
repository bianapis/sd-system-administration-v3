...
/**
 * BQCapacityPlanningandResilienceRequestOutputModel
 */
public class BQCapacityPlanningandResilienceRequestOutputModel   {
  ...
  private String capacityPlanningandResilienceRequestActionTaskReference = null;

  private Object capacityPlanningandResilienceRequestActionTaskRecord = null;

  private String capacityPlanningandResilienceRequestRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Capacity Planning and Resilience instance request service call 
   * @return capacityPlanningandResilienceRequestActionTaskReference
  **/

  public String getCapacityPlanningandResilienceRequestActionTaskReference() {
    return capacityPlanningandResilienceRequestActionTaskReference;
  }

  public void setCapacityPlanningandResilienceRequestActionTaskReference(String capacityPlanningandResilienceRequestActionTaskReference) {
    this.capacityPlanningandResilienceRequestActionTaskReference = capacityPlanningandResilienceRequestActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The request service call consolidated processing record 
   * @return capacityPlanningandResilienceRequestActionTaskRecord
  **/

  public Object getCapacityPlanningandResilienceRequestActionTaskRecord() {
    return capacityPlanningandResilienceRequestActionTaskRecord;
  }

  public void setCapacityPlanningandResilienceRequestActionTaskRecord(Object capacityPlanningandResilienceRequestActionTaskRecord) {
    this.capacityPlanningandResilienceRequestActionTaskRecord = capacityPlanningandResilienceRequestActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Capacity Planning and Resilience service request record 
   * @return capacityPlanningandResilienceRequestRecordReference
  **/

  public String getCapacityPlanningandResilienceRequestRecordReference() {
    return capacityPlanningandResilienceRequestRecordReference;
  }

  public void setCapacityPlanningandResilienceRequestRecordReference(String capacityPlanningandResilienceRequestRecordReference) {
    this.capacityPlanningandResilienceRequestRecordReference = capacityPlanningandResilienceRequestRecordReference;
  }
